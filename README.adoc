...
* Adds rudimentary support for batch processing (invocation sequence with mutiple samplers and/or prompt substitutions)
* Adds new key bindings:
...
* To stop a batch run (hack): Open the b-dialog and wait for current invocation to finish, or just reload the page.
