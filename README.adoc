...
`link:amazon-links.user.js[]` adds a direct product link (no unnecessary parameters etc.) and a https://keepa.com[keepa] price to amazon product pages.

* Makes the price a link to the product's keepa price history page
