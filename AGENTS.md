...
Shared conventions (commit messages etc.) are not kept in this repository —
they are provided machine-wide from the dotfiles repo and load automatically
(see `docs/agent-instructions.adoc` there).
